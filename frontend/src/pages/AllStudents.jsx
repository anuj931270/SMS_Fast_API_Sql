...
export default function AllStudents() {
  ...
  return (
    <div className="min-h-screen bg-[#f6f7fb]">
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 flex w-[280px] flex-col border-r border-slate-200 bg-white transition-transform duration-300 lg:translate-x-0 ${sidebarOpen
          ? "translate-x-0"
          : "-translate-x-full"
          }`}
      >
